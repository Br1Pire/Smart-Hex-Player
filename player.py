...
class SmartPlayer(Player):
    ...
    def evaluate_early_game(self, board):
        ...
        for i in board.player_positions[self.player_id]:
            score += weights[i[0]][i[1]]
        for i in board.player_positions[2]:
            score -= weights[i[0]][i[1]]
    ...
    def evaluate_mid_game(self, board):
        board_eval = self.evaluate_early_game(board)
